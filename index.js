    ...
    return (
		<div style="width:165px; height:125px; box-sizing: border-box; padding: 1px; overflow: hidden; position: absolute; margin: -12px 0 0 -10px; ">
			...
			<div style="width:100%; height:20px; background-color: rgba(255,255,255,0.5); position: relative; z-index:1; ">
				<div style="background: url('http://www.pbanimado.com.br/rung/icon-cacau.png') no-repeat center center; background-size: 100%; width:50px; height: 50px; position: absolute; z-index:2; margin: -10px 0 0 54px; border: 3px solid #FFF; -webkit-border-radius: 50%; -moz-border-radius: 50%; border-radius: 50%;"></div>
			</div>
...
function main(context, done) {
	...
	// variáveis padrão
	var fonte_titulo = '';
	var fonte_link = 'https://www.noticiasagricolas.com.br/cotacoes/cacau/';
	...
	const server = pipe(
		cond([
			[equals('Cacau - Fonte CNPC'), () => 'cacau-cnpc'],

			[contains(__, ['Mercado do Cacau - Bahia', 'Mercado do Cacau - Espírito Santo', 'Mercado do Cacau - Pará']), () => 'cacau-mercado-do-cacau'],

			[equals('Bolsa de Nova Iorque'), () => 'cacau-bolsa-de-nova-iorque-nybot'],
	...
	switch (fonte) {
    	...
    	case 'Cacau - Fonte CNPC':
    		fonte_titulo		= 'Cacau - Fonte CNPC';
    	...
    	case 'Mercado do Cacau - Bahia':
    		fonte_titulo		= 'Mercado do Cacau';
			fonte_coluna_res 	= returnSelector('result', '1', '1');
			fonte_preco_res 	= returnSelector('result', '1', '2');
			fonte_variacao_res 	= returnSelector('result', '1', '3');
    		break;

    	case 'Mercado do Cacau - Espírito Santo':
    		fonte_titulo		= 'Mercado do Cacau';
...
const lista_fontes = [
	...
	'Cacau - Fonte CNPC',
	'Mercado do Cacau - Bahia',
	'Mercado do Cacau - Espírito Santo',
	'Mercado do Cacau - Pará',
...
export default create(main, {
    params,
    primaryKey: true,
    title: _("Cotação Cacau"),
    description: _("Acompanhe a cotação do cacau em diversas praças."),
	preview: render('Mercado do Cacau', 'Estado', 'Espírito Santo / saca', 'Preço (R$)', '101,00')
});